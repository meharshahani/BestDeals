	...
	protected void doGet(HttpServletRequest request,
		...
		if(action.equals("Addproduct"))
		{
			...
			pw.print("<form method='get' action='ProductCrud'>"
					...
					+ "<h3>Product Type</h3></td><td><select name='producttype' class='input'><option value='tvs' selected>TV</option><option value='laptop'>Laptop</option><option value='tablets'>Tablet</option><option value='headphone'>Headphone</option><option value='va'>Voice Assistant</option><option value='ss'>Sound system</option><option value='fw'>Fitness Watch</option><option value='sw'>Smart Watch</option><option value='wp'>Wireless Plans</option></select>"
					+ "</td></tr><tr><td>"
